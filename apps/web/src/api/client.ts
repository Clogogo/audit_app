...
export const forgotPassword = (email: string, newPassword: string, recoveryCode: string) =>
  api.post<{ message: string }>('/auth/forgot-password', { email, new_password: newPassword, recovery_code: recoveryCode }).then(unwrap);
